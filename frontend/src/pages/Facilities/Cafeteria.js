  ...
  return (
    <div className="bg-white py-12 px-4 flex justify-center">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-4xl w-full">
        ...
        <h3 className="text-xl font-semibold text-green-700 mt-8 mb-2">
          Our Facilities
        </h3>
        <p className="text-base text-gray-700 leading-relaxed text-justify">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-5">
          {["/images/cafe1.jpg", "/images/cafe2.jpg", "/images/cafe3.jpg", "/images/cafe4.jpg"].map((image, index) => (
            <div
              key={index}
              className="w-[180px] h-[170px] bg-white p-2 rounded-lg shadow-md transition-transform transform hover:scale-105"
            >
              <img
